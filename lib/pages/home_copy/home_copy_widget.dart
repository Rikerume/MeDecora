                        ...
                        Padding(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                StreamBuilder<List<PublicoesRecord>>(
                                  stream: queryPublicoesRecord(
                                    queryBuilder: (publicoesRecord) =>
                                        publicoesRecord.orderBy('time_posted',
                                            descending: true),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    List<PublicoesRecord>
                                        listViewPublicoesRecordList =
                                        snapshot.data!;
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewPublicoesRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewPublicoesRecord =
                                            listViewPublicoesRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
